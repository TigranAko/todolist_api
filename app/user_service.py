...
class UserService:
    ...
    async def about(self, user_id):
        result = await self.repo.find_one(user_id)
        return result

    async def update(): ...

    async def delete(self, user_id):
        result = await self.repo.delete_one(user_id)
        return result
